### Test the performance with the 10-25 strategy
...
results_df <- rbind(results_df,
                    c(10, 25, 10, "parametric", 1000, temp@time_taken, "no"))
temp@time_taken
temp <- estimate_risk_roll(
  data = data_10vars,
  weights = NULL,
...
results_df <- rbind(results_df,
                    c(10, 25, 10, "parametric", 10000, temp@time_taken, "no"))
temp@time_taken
temp <- estimate_risk_roll(
  data = data_10vars,
  weights = NULL,
...
results_df <- rbind(results_df,
                    c(10, 25, 10, "parametric", 100000, temp@time_taken, "no"))
temp@time_taken
# conditional
temp <- estimate_risk_roll(
  data = data_10vars,
...
results_df <- rbind(results_df,
                    c(10, 25, 10, "parametric", 1000, temp@time_taken, "yes"))
temp@time_taken
temp <- estimate_risk_roll(
  data = data_10vars,
  weights = NULL,
...
results_df <- rbind(results_df,
                    c(10, 25, 10, "parametric", 10000, temp@time_taken, "yes"))
temp@time_taken

# here only one quantile level due to extensive memory requirements >100Gb for 2
temp <- estimate_risk_roll(
  data = data_10vars,
  weights = NULL,
  marginal_settings = cond_marg,
...
results_df <- rbind(results_df,
                    c(10, 25, 10, "parametric", 100000, temp@time_taken, "yes"))
