...
Similarly to the single conditional and unconditional case one can observe more extreme value copulas for the second time frame. From these results one would expect the double conditional risk measures to behave like the single conditional ones conditioned on the Eurostoxx 50 index.
