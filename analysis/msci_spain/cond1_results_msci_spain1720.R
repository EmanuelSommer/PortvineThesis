### Single conditional msci spain risk estimates for the case studies 2017-2020
...
cond_risk_roll_17_20_sp500 <- estimate_risk_roll(
  data = msci_spain_17_20[, 3:12],
...
cond_risk_roll_17_20_eurostoxx50 <- estimate_risk_roll(
  data = msci_spain_17_20[, c(3:11, 13)],
...
save(
  cond_risk_roll_17_20_sp500,
  cond_risk_roll_17_20_eurostoxx50,
  file = "msci_spain_cond1_1720.RData"
)
